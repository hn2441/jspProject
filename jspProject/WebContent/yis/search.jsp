			...
			%>
				<div class="container">
						<div style="float: left; margin: 25px; border: 2px solid; background-image: url('images/pic02.jpg'); background-size: 1000%">
								<br> <h3 align="center"><a href="product.jsp?no=<%= dto.getNo() %>"> 상품: <%= dto.getTitle() %></a></h3> <br>
								<a href="product.jsp?no=<%= dto.getNo() %>"><img src="<%= dto.getImg() %>" width="350" height="300"/></a> <br>
								<h3 align="center"><a href="product.jsp?no=<%= dto.getNo() %>"> 가격: <%= dto.getPrice() %></a></h3> 
						</div>
			<%	
				}
			}
